package es.malvarez.microservices.collision.service;

import es.malvarez.microservices.api.ParticleType;
import es.malvarez.microservices.collision.domain.Collision;
import es.malvarez.microservices.collision.domain.Particle;
import es.malvarez.microservices.collision.repository.CollisionRepository;
